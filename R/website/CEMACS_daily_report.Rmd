...
## Underwater temperature (T) 1 and 2
Underwater temperature (T) in degree celsius near the surface of the water (dark blue, 1) and the seabed (light blue, 2). The temperature at the surface would dip to cool temperatures due to low tide which causes the sensor to be above the water surface.

```{r , echo=FALSE, warning = FALSE, message = FALSE}
plot(df_web$time_stamp, df_web$TS_1_1_1, type ='o', pch = 19, xlab = '',
     ylab = '', col = 'darkblue', ylim =c())
